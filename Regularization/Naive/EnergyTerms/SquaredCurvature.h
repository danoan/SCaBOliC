...
namespace Regularization
{
    namespace Naive
    {
        ...
        public:
            ...
            typedef ICoefficientsComputer<TCoefficientData> MyCoefficientsComputer;
        ...
        private:
            ...
            void setCoeffs(UnaryTermsMatrix& UTM,
                           ...
                           const OptimizationDigitalRegions& ODR,
                           unsigned long int radius)
            {
                DigitalSet temp(ODR.domain);
                ImageProc::DigitalBallIntersection DBIOptimization(radius, ODR.optRegion);
